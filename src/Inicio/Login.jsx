        ...
        setIsLoading(true);
            ...
            try {
                const response = await fetch('https://backendodontologia.onrender.com/api/users/login', {
                    ...
                    credentials: 'include',  // Mantener esto
                    body: JSON.stringify({
                ...
                // Verificar las cookies después del login
                console.log('Todas las cookies:', document.cookie);
                const carolDentalCookie = document.cookie
                    .split('; ')
                    .find(row => row.startsWith('carolDental='));
                console.log('Cookie carolDental:', carolDentalCookie);
